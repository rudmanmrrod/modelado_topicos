...
"""
## @package modelado_topicos.settings
#
...
SECRET_KEY = 'u%&)4g+b^&wj2t(l^b9(nm9@mtr^-&m31rq63=0b4cx8fc*tfe'
...
ROOT_URLCONF = 'modelado_topicos.urls'
...
WSGI_APPLICATION = 'modelado_topicos.wsgi.application'
...
PROCESAMIENTO_PATH = os.path.join(BASE_DIR, 'static/procesamiento')
